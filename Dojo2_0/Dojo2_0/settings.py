...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173", 
     "http://127.0.0.1:8000",  # Frontend dev server (Vite)
]
...
EASYTIME_AUTH_URL = '/api/api-token-auth/'
BIO_DEV_MODE = False  # Set to False for production
# BIO_DEV_MODE = True  # Set to False for production
