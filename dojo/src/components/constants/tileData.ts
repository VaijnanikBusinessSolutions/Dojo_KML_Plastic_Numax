...
export const tiles = [
  {
    ...
    links: [
      ...
      { name: 'Advance Production Plan Dashboard', path: '/advanced', icon: Activity },
      { name: 'Advanced Manpower Planning Dashboard', path: '/advance', icon: AlignEndHorizontal },
    ],
    icon: BarChart3,
    statusText: 'Live',
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'ObservanceSheet', path: '/Observance', icon: Book },
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'Man-Machine Interlinkage', path: '/easytime-biometric', icon: FileStack },// Numax easytimepro
    ],
    icon: Network,
    statusText: 'Updated',
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'User Manuals', path: '/ContentPage', icon: FileStack },
    ],
    icon: Microscope,
    statusText: 'Updated',
    borderTopColor: 'border-t-blue-900',
